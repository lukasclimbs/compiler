...
(* OASIS_START *)
(* DO NOT EDIT (digest: e93c75f02097c66bf4420e1e98918e34) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "A basic compiler with expressions for arithmetic and booleans.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               ...
               Test
                 ({
                     cs_name = "lex_and_parser_pipeline";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_digest = Some "“j\134ÿ‰8jµoﬁ@i[L\127œ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
