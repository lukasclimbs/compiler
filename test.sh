...
echo "Testing the lexing pipeline."
echo "Test 1:"
./compiler.native -lex ./tests/example.src > tmp.txt
diff tmp.txt ./tests/example.lex.out

echo "Test 2:"
./compiler.native -lex ./tests/example1.src > tmp.txt
diff tmp.txt ./tests/example1.lex.out

echo "Test 3:"
./compiler.native -lex ./tests/example2.src > tmp.txt
diff tmp.txt ./tests/example2.lex.out

echo "Test 4:"
./compiler.native -lex ./tests/example3.src > tmp.txt
diff tmp.txt ./tests/example3.lex.out

echo "Test 5:"
./compiler.native -lex ./tests/example4.src > tmp.txt
diff tmp.txt ./tests/example4.lex.out

echo "Test 6:"
./compiler.native -lex ./tests/example5.src > tmp.txt
diff tmp.txt ./tests/example5.lex.out

echo "Test 7:"
./compiler.native -lex ./tests/example6.src > tmp.txt
diff tmp.txt ./tests/example6.lex.out

echo "Test 8:"
./compiler.native -lex ./tests/example7.src > tmp.txt
diff tmp.txt ./tests/example7.lex.out

echo "Test 9:"
./compiler.native -lex ./tests/example8.src > tmp.txt
diff tmp.txt ./tests/example8.lex.out

echo "Test 10:"
./compiler.native -lex ./tests/example9.src > tmp.txt
diff tmp.txt ./tests/example9.lex.out

echo "Test 11:"
./compiler.native -lex ./tests/example10.src > tmp.txt
diff tmp.txt ./tests/example10.lex.out

echo "Test 12:"
./compiler.native -lex ./tests/example11.src

echo "if all are blank, the program has passed the lexing test suite! Test 12 will return a fatal error. This is intentional, as this test has extra characters in it, and this is the expected behavior."
